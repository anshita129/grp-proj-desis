...
import Profile from "./modules/users/pages/Profile"; // change path if Profile.jsx is elsewhere
                ...
                <nav className="w-64 bg-slate-800 border-r border-slate-700 flex flex-col">
                    ...
                    <div className="p-4 border-t border-slate-700 text-center">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 p-3 rounded-lg bg-slate-700 hover:bg-slate-600 transition-colors"
                        >
