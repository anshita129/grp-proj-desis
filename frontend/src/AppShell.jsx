        ...
        <div className="flex flex-col h-screen bg-slate-900 text-slate-100 font-sans">
            ...
            <header className="h-16 bg-slate-800 border-b border-slate-700 flex items-center justify-between px-6 shrink-0">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link to="/profile">
                        <div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold text-sm hover:ring-2 ring-blue-400 transition-all cursor-pointer">
            ...
            <div className="flex flex-1 overflow-hidden relative">
                {/* Collapsible Sidebar Overlay on Mobile, Push on Desktop */}
                <div 
                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                <Link
                                    ...
                                    to={item.path}
                                    onClick={() => {
                                        // Auto-close on small screens when a link is clicked
